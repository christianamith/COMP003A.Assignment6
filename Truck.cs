namespace COMP003A.Assignment6
{
    ...
    internal class Truck : Vehicle
    {
        ...
        /// <summary>
        /// Constructor that takes 4 parameters: truckBand, truckModel, truckNumberOfWheels, and sizeOfTruckBed
        /// It reuses the base class (Vehicle)'s constructor that 3 parameters: brand, model, numberOfWheels
        /// </summary>
