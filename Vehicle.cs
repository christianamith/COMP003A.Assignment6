...
{
	/// <summary>
	/// Abstracts describe a contract but does nort provide a full implementation of the contract.
    ...
    abstract class Vehicle : IVehicle
	{
		...
		/// <param name="numberOfWheels">Integer input for the number of wheels</param>
